...
[![release](https://img.shields.io/badge/release-v0.7.0-blue.svg)](https://github.com/sisong/tinyuz/releases) 
...
**tinyuz** is a lossless compression algorithm, which is characterized by a very small decompress code(disk or Flash occupancy, compiled from source code); The code compiled by Mbed Studio is 868 bytes. 
